...
## 🚀 Recent Work (Updated May 20, 2026)

- On **May 19, 2026**, I opened a draft [Vinyl PR #8](https://github.com/Jason-Latz/vinyl/pull/8) that collapses active-transcript fetches into a single joined GRDB read, adds repository coverage for multi-version transcript selection, and documents the hot-path database read behind the local transcription and analysis flow.
- Also on **May 19, 2026**, I pushed a pair of private experiment tracks: one turned an unpublished tool stack into a draft PR by fixing a missing console-script entrypoint, and another seeded a new CLI prototype around state scoring, response-lane planning, markdown brief rendering, and sample artifacts.
